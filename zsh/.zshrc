...
alias gd="git diff"
alias gp="git push"
# trunkyard soak: dev-copy path until the mise release lands at cutover.
alias gwss="$HOME/code/trunkyard/bin/trunkyard status"
alias gwp="$HOME/code/trunkyard/bin/trunkyard pull"
alias gwt="$HOME/code/trunkyard/bin/trunkyard new"
alias wts="wt switch"
